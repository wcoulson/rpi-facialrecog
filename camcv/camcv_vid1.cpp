...
#include "/home/pi/libfacerec/bytefish-libfacerec-e1b143d/include/facerec.hpp"	//<-- to modify
...
/////////////////////////////////
	...
	// life is hard.
	people[P_WAYNE] 	= "Wayne";
	people[P_AMY]   	= "Amy";
	people[P_AIDEN]		= "Aiden";
	people[P_CASSIUS]	= "Cassius";
        people[P_PHEEN]         = "Phoenix";
